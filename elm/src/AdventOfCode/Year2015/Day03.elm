module AdventOfCode.Year2015.Day03 exposing
    ( rawInput
    , run
    )
...
processInstructions =
    List.filterMap instructionToDirection


instructionToDirection : String -> Maybe Direction
instructionToDirection string =
    case string of
        "^" ->
            Just North
