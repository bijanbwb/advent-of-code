defmodule AdventOfCode.Year2015.Day08 do
  ...
  @type input :: String.t()
  @type line :: String.t()
  @type total_character_count :: non_neg_integer()
  @type string_character_count :: non_neg_integer()
  @type counts :: {total_character_count, string_character_count}
  @type result :: non_neg_integer()

  #
  # RUN
  #

  @spec run(input :: input()) :: result()
  def run(input) do
    input
    |> process_input()
    |> process_lines()
  ...
  def count_escape_characters(line) do
    line
    |> String.graphemes()
    |> Enum.count(&is_escape_character?/1)
  end

  @spec is_escape_character?(character :: String.grapheme()) :: boolean()
  def is_escape_character?(character) do
    character == "\\" or
      character == "\""
  end
